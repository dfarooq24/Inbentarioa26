...
{
    /// <summary>
    /// Gailu existente baten datuak editatzeko formularioa.
    /// Konstruktorean ID hartzen du eta datu-basetik datuak automatikoki kargatzen ditu.
    /// Polimorfismoa: <c>is</c> operadorearen bidez mota detektatu eta
    /// dagozkion eremuak aktibatu edo desaktibatzen ditu.
    /// </summary>
    public partial class GailuaEditatuForm : Form
    {
        ...
        /// <summary>Editatzen ari den gailu ID zenbakia.</summary>
        private readonly int _id;

        /// <summary>
        /// GailuaEditatuForm berri bat hasieratzen du eta gailua kargatzen du.
        /// </summary>
        /// <param name="id">Editatu beharreko gailu ID zenbakia.</param>
        public GailuaEditatuForm(int id) { InitializeComponent(); _id = id; KargatuDatuak(); }

        /// <summary>
        /// Datu-basetik gailu datuak kargatu eta formularioa betetzen du.
        /// Mota arabera propietate espezifikoen panelak erakusten ditu.
        /// </summary>
        ...
        /// <summary>Mota aldatzean propietate espezifikoen panelak eguneratzen ditu.</summary>
        ...
        /// Aldaketak Gailua objektuan gorde eta datu-basean eguneratu.
        /// </summary>
