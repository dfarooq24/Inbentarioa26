namespace ERRONKA3
{
    partial class GailuaGehituForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            var header = UIHelper.MakeHeader("➕","Gailu Berria Gehitu","Inbentarioan gailu berri bat erregistratu",UIHelper.Success);
            ...
            chkKolorea.AutoSize=true; chkKolorea.Location=new Point(24,16); chkKolorea.Enabled=false;
            ...
            btnGorde=UIHelper.MakeBtn("✔  Gorde",UIHelper.Success,new Size(140,38),new Point(460,10),btnGorde_Click);
            ...
            StartPosition=FormStartPosition.CenterParent; Text="Gailu berria gehitu";
            ResumeLayout(false);
        }
