...
CREATE TABLE `erabiltzailea` (
  `id_erab` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `erabiltzailea_ibfk_1` FOREIGN KEY (`id_mintegia`) REFERENCES `mintegia` (`id_mintegia`)
...
INSERT INTO `erabiltzailea` VALUES (1,'ikt','1234','admin',1),(3,'admin','1234','irakaslea',2),(4,'admin','12345','admin',1),(5,'andoniin','41','admin',1);
